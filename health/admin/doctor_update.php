...
if(isset($_POST['submit'])&&isset($_POST['doctor_id'])
    ...
    //Creating the Query
     $sql="UPDATE doctor SET expertness='$expertness',doctor_name='$doctor_name', chamber='$chamber', qualification='$qualification',hospital='$hospital' ,visit=$visit WHERE doctor_id = $doctor_id";
     //Running the Query
...
<body>
  <section class="container">
    ...
    <input class="button" name="submit" id="submit" tabindex="5" value="Update Data!" type="submit">   
